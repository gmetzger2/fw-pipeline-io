...
class TestFileDownloader(unittest.TestCase):
    def setUp(self):
        ...
        self.temp_dir = os.path.join(
            os.path.abspath(os.path.dirname(__file__)), "temp_test_dir"
        )
    ...
    def test_download_files(self, mock_mkdtemp):
        ...
        self.mock_fw_client.download_file.assert_called_once_with(
            mock_file_entry1, os.path.join(self.temp_dir, "test_file.zip")
        )
